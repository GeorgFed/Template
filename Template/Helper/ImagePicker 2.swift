...
//
//  Created by Georg on 27.10.2019.
//  Copyright © 2019 Georg. All rights reserved.
//

import UIKit

/// # MAKE PHOTOS OR PICK IMAGES FROM USER LIBRARY
/// NOTE: Requires Info.plist keys
/// Alert will be presented for user to grant access to media
...
extension ImagePicker: UIImagePickerControllerDelegate {
    ...
    public func imagePickerController(_ picker: UIImagePickerController,
        ...
        self.pickerController(picker, didSelect: selectedPickerImg)
    }
}
